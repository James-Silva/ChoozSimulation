...
for i in range(0,40):
    fileName = 'run_joe10MeV_'+ str(i+1) +'.mac'
    with open(fileName,'w') as f:
        f.write('/control/verbose 0\n')
        f.write('/run/verbose 0\n')
        f.write('/event/verbose 0\n')
        f.write('/tracking/verbose 0\n')
        f.write('/ricochetchoozsim/tree/setOutputFileName ChoozWithAirJoe10MeV_'+str(i+1)+'.root\n')
        ...
        f.write('/ricochetchoozsim/generator/setneutronsourcespectrum input_spectra/fast_neutron_spectrum_Joe-32GeV-10MeVthreshold.txt\n')
