...
private:
	...
	//0o0o0o0o
	G4Box* 				    		muonShielding;
	G4LogicalVolume* 			muonShielding_lv;
	G4VPhysicalVolume*		muonShielding_pv;

	G4Box* 				    		pbShielding1;
	G4LogicalVolume* 			pbShielding1_lv;
	G4VPhysicalVolume*		pbShielding1_pv;

	G4Box* 				    		pe_b_Shielding1;
	G4LogicalVolume* 			pe_b_Shielding1_lv;
	G4VPhysicalVolume*		pe_b_Shielding1_pv;

	G4Box* 				    		pbShielding2;
	G4LogicalVolume* 			pbShielding2_lv;
	G4VPhysicalVolume*		pbShielding2_pv;

	G4Box* 				    		pe_b_Shielding2;
	G4LogicalVolume* 			pe_b_Shielding2_lv;
	G4VPhysicalVolume*		pe_b_Shielding2_pv;

	G4Box* 				    		pbShielding3;
	G4LogicalVolume* 			pbShielding3_lv;
	G4VPhysicalVolume*		pbShielding3_pv;

	G4Box*								shieldInterior;
	G4LogicalVolume*			shieldInterior_lv;
	G4VPhysicalVolume*		shieldInterior_pv;
	//0o0o0o0o
